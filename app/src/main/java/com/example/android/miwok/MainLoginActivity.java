...
public class MainLoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private void handleSignInResult(GoogleSignInResult result){
        if(result.isSuccess()){
            ...
            Log.e("aa", "Login Unsuccessful. "+result);
        ...
        firebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Log.d("abc", "signInWithCredential:onComplete:" + task.isSuccessful());
                        if (task.isSuccessful()) {
                            Toast.makeText(MainLoginActivity.this, "Login successful", Toast.LENGTH_SHORT).show();
//                            gotoProfile();
                            Intent intent= new Intent(MainLoginActivity.this,LangActivity.class);
                            startActivity(intent);
                        } else {
                            Log.w("sign", "signInWithCredential" + task.getException().getMessage());
